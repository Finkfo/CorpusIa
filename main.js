...
async function toggleExplode() {
  ...
  if (explodeOn) {
    // SDK3DVerse.engineAPI.playAnimationSequence(
    //   "da296f34-15a1-48be-bb2c-5a230fca8120"
    // );
    SDK3DVerse.engineAPI.playAnimationSequence(
      "879c2e7b-4efe-4fad-9165-338d017ab6d0"
    );
    SDK3DVerse.engineAPI.playAnimationSequence(
      "c2f13b9d-e36b-47ae-8f4d-1757a96776bb"
    );
  }
}
...
async function InitApp() {
  await SDK3DVerse.joinOrStartSession({
    ...
    sceneUUID: "33f48354-a617-40e9-b302-b69e57c0eb8c",
